<html><head><title>Slides and Notes</title></head><body><table><tr><td><img src="slide0.png"></td><td>Lesson Overview
...
</td></tr><tr><td><img src="slide1.png"></td><td>
</td></tr><tr><td><img src="slide2.png"></td><td> Discussion Goal: Encourage students to think of things that make recommendations, especially different apps or websites. For example, they may be recommended videos from Youtube or new songs on a music app. Some apps may ask you to pick preferences before using them to help figure out your preferences. Some websites give recommendations at the end of an experience, like a takeout menu or online grocery store recommending new items before checking out. Try to crowdsource a variety of examples before continuing to the next prompt
</td></tr><tr><td><img src="slide3.png"></td><td>Discussion Goal: Responses here will vary, and there's no expected answer. Instead, focus on the tension between getting recommendations that are accurate and how not every recommendation may feel like it matches each student's interests and personality.
...
</td></tr><tr><td><img src="slide4.png"></td><td>
</td></tr><tr><td><img src="slide5.png"></td><td>Distribute: Pass out the WeTube Content Creators resource.
</td></tr><tr><td><img src="slide6.png"></td><td>Model: Show students the widget and demonstrate how to select a person and then view the video recommendations.
...
</td></tr><tr><td><img src="slide7.png"></td><td>Code Studio: Send students to the first level in Code Studio. As they work, have them consider the following prompt
...
</td></tr><tr><td><img src="slide8.png"></td><td>Regroup: Have students regroup to discuss the following prompt
...
</td></tr><tr><td><img src="slide9.png"></td><td>Video: Show the How AI Works: How Neural Networks Work
